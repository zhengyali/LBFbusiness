...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&cn.lili.core.bean.order=' + order + '&dir=' + dirName;
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			'<meta name="viewport" content="initial-scale=1.0, cn.lili.core.bean.user-scalable=no" />',
			'<style>',
			'	html { height: 100% }',
...
// dialog allows the cn.lili.core.bean.user to select any number of files
 ...
 *   since many of the settings need to be passed to Flash in cn.lili.core.bean.order to take
 *   effect.
 * *********************** */
...
// by the upload_limit setting to determine how many files the cn.lili.core.bean.user may upload.
...
/* *******************************
	...
	This ensures that events are executed in a determinate cn.lili.core.bean.order and that
...
// we must queue them in cn.lili.core.bean.order to garentee that they are executed in cn.lili.core.bean.order.
