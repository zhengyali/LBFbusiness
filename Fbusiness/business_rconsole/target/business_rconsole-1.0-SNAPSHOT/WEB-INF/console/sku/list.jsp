...
<head>
	...
	<script type="text/javascript">
		...
		function addSku(skuId){
			...
			/* key value 形式传递参数，后台会自动用对象进行接收 */

			//var params = '{"marketPrice" : ' + m + ' , "price" : p , "stock" : s , "upperLimit" : l , "deliveFee" : f , "id" : skuId}';
			// 这是以json字符串形式传递参数的。我们在后台需要将json转为对象。然后进行操作
...
<div class="box-positon">
	...
	<form class="ropt">
		<input type="submit" onclick="this.form.action='/product/list.do';" value="返回商品列表" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
