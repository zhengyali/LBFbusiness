...
$(function(){
	$("#loginsubmit").click(function(){//这个id绑定一个click事件
...
<body>
	...
	<div class="w">
		<div id="logo">
			<a href="javascript:;"> <img src="/images/XBB2.png" alt="LB"
							...
							<div class="coagent">
								...
								<ul>
									<li><a href="javascript:void(0)"
										clstag="pageclick|keycount|20150112ABD|3">LB钱包</a> <span
										class="line">|</span></li>
									<li><a href="javascript:void(0)"
					...
					<div class="qrcode-login">
						<div class="mc">
							<div class="qrcode-desc">
								<h2>
									用LBAPP <span class="ml5">扫码安全登录</span>
								</h2>
							</div>
		...
		<div id="footer-2013">
			<div class="links">
				<a rel="nofollow" href="javascript:;"> 关于我们 </a> | <a rel="nofollow"
					...
					href="javascript:;"> 手机LB </a> | <a href="javascript:;"> 友情链接
				</a> | <a href="javascript:;"> 销售联盟 </a> | <a href="javascript:;">
					LB社区 </a> | <a href="javascript:;"> LB公益 </a> | <a
					clstag="pageclick|keycount|20150112ABD|9">English Site</a>
			</div>
			<div class="copyright">
				Copyright&#169;2016-2020&nbsp;&nbsp;LB&nbsp;版权所有</div>
		</div>
	</div>
