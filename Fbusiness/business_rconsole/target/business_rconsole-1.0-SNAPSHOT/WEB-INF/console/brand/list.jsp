	...
	<tbody class="pn-ltbody">
	  <c:forEach items="${pagination.list }" var="brand">
		  <tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			  ...
			  <td align="center" width="400">${brand.description}</td>
			  ...
			  <td align="center">
				  <a class="pn-opt" href="/brand/toEdit.do?id=${brand.id }&name=${name}&isDisplay=${isDisplay}&pageNo=${pagination.pageNo}" >修改</a>
			  </td>
		  </tr>
	  </c:forEach>
	</tbody>
