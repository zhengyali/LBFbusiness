...
<script type="text/javascript" >
	...
	function cancel(key){
		...
		}else if(key=='品牌'&& price ==''){
			window.location.href = "/search?keyword=" + keyword;
		}
		else if(key=='价格'&& brandId !=''){
			//刷新
...
<div id="J_crumbsBar" class="crumbs-bar">
	...
	<div class="crumbs-nav">
		<div class="crumbs-nav-main clearfix">
			...
			<div class="crumbs-nav-item">
				<strong class="search-key">${param.keyword}</strong>
			</div>
			<c:if test="${fn:length(map) != 0 }">
			<div class="sl-b-selected J_brandSelected">
				<span class="crumbs-arrow">已选条件：</span>
					<c:forEach items="${map }" var="m">
						<a title="${m.value}" onclick="cancel('${m.key }')" href="javascript:;" class="crumb-select-item">
...
<div id="J_goodsList" class="goods-list-v1 gl-type-1 J-goods-list">
	<ul class="gl-warp clearfix" data-tpl="1">
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				<div class="p-img">
					<%-- href 会出现二次提交的情况，因此使用 a 标签中的onclick事件 --%>
				...
				<div class="p-name p-name-type-2">   <%--鼠标点击事件，推广，鼠标放上去就有--%>
					<a target="_blank" title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" onclick="window.open('http://localhost:8095/html/product/${product.id}.html')">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
			...
			<div id="J_recommendGoods" class="ab-goods" style="display: block;">
				...
				<div class="mc">
					<ul class="clearfix">
						<li>  
							<div class="p-img">      
								<a  href="javascript:;" title="名夫短袖t恤男新款2018夏季黑红拼接小丑短袖撞色男女情侣T恤 L" style="position: relative;">
						     		<img width="160" height="160" data-img="1" src="/images/page3.3.jpg" class="err-product">
						     ...
						     <div class="p-name">      
						     <a target="_blank" href="javascript:;" title="名夫短袖t恤男新款2018夏季黑红拼接小丑短袖撞色男女情侣T恤 L">
						     	<em>名夫短袖t恤男新款2018夏季黑红拼接小丑短袖撞色男女情侣T恤  L</em>
						     </a>  
						     </div>
						 </li>
						<li>  
							<div class="p-img">      
								<a  href="javascript:;" title="喜悦萌苗情侣装2018春夏装新款休闲条纹T恤七分裤连衣裙两件套套装女班服潮 L" style="position: relative;">
						     		<img width="160" height="160" data-img="1" src="/images/page7.1.jpg" class="err-product">
						     		<div id="gwd_float_curve_trigger" class="gwd_float_curve_trigger gwd_float_curve_up" style="left: 40px; top: 49px;">
						     		<div class="gwd_float_curve_wrapper">
						     		<span class="gwd_float_curve_trigger_icon" style="background-image:url(chrome-extension://dobbgecnokkloebjbcnjpgcopegjabpa/images/background_new.png)"></span>
						     		<span class="gwd_float_curve_trigger_hint">上涨</span>
						     ...
						     <div class="p-name">      
						     <a target="_blank" href="javascript:;" title="喜悦萌苗情侣装2018春夏装新款休闲条纹T恤七分裤连衣裙两件套套装女班服潮 L">
						     	<em>喜悦萌苗情侣装2018春夏装新款休闲条纹T恤七分裤连衣裙两件套套装女班服潮 L</em>
						     </a>  
						     </div>
						 </li>
						<li>  
							<div class="p-img">      
								<a  href="javascript:;" title="短袖t恤男2018夏季新款青年圆领韩版纯棉情侣装半袖衣服潮流 L" style="position: relative;">
						     		<img width="160" height="160" data-img="1" src="/images/page9.2.jpg" class="err-product">
						     		<div id="gwd_float_curve_trigger" class="gwd_float_curve_trigger gwd_float_curve_up" style="left: 40px; top: 49px;">
						     		<div class="gwd_float_curve_wrapper">
						     		<span class="gwd_float_curve_trigger_icon" style="background-image:url(chrome-extension://dobbgecnokkloebjbcnjpgcopegjabpa/images/background_new.png)"></span>
						     		<span class="gwd_float_curve_trigger_hint">上涨</span>
						     ...
						     <div class="p-name">      
						     <a target="_blank" href="javascript:;" title="短袖t恤男2018夏季新款青年圆领韩版纯棉情侣装半袖衣服潮流 L">
						     	<em>短袖t恤男2018夏季新款青年圆领韩版纯棉情侣装半袖衣服潮流 L</em>
						     </a>  
						     </div>
						 </li>
						 						<li>  
							<div class="p-img">      
								<a  href="javascript:;" title="贝蕾曼情侣装2018夏装新款短袖韩范笑脸 L" style="position: relative;">
						     		<img width="160" height="160" data-img="1" src="/images/page14.1.jpg" class="err-product">
						     		<div id="gwd_float_curve_trigger" class="gwd_float_curve_trigger gwd_float_curve_up" style="left: 40px; top: 49px;">
						     		<div class="gwd_float_curve_wrapper">
						     		<span class="gwd_float_curve_trigger_icon" style="background-image:url(chrome-extension://dobbgecnokkloebjbcnjpgcopegjabpa/images/background_new.png)"></span>
						     		<span class="gwd_float_curve_trigger_hint">上涨</span>
						     ...
						     <div class="p-name">      
						     <a target="_blank" href="javascript:;" title="贝蕾曼情侣装2018夏装新款短袖韩范笑脸 L">
						     	<em>贝蕾曼情侣装2018夏装新款短袖韩范笑脸 L</em>
						     </a>  
						     </div>
						 </li>
						 						<li>  
							<div class="p-img">      
								<a  href="javascript:;" title="贝蕾曼情侣装2018夏装新款短袖韩范笑脸 L" style="position: relative;">
						     		<img width="160" height="160" data-img="1" src="/images/page2.2.jpg" class="err-product">
						     		<div id="gwd_float_curve_trigger" class="gwd_float_curve_trigger gwd_float_curve_up" style="left: 40px; top: 49px;">
						     		<div class="gwd_float_curve_wrapper">
						     		<span class="gwd_float_curve_trigger_icon" style="background-image:url(chrome-extension://dobbgecnokkloebjbcnjpgcopegjabpa/images/background_new.png)"></span>
						     		<span class="gwd_float_curve_trigger_hint">上涨</span>
