...
<!DOCTYPE html PULBIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="w w1 header clearfix">
	<div id="logo">
		<a href="/"><img
				src="/images/XBB2.png" title="返回LB商城首页" alt="返回LB商城首页"></a>
	</div>
	<div class="language">
			...
			<div id="show">
				...
				<div class="cart-inner">
					<div class="cart-thead clearfix">
						...
						<div class="column t-price">LB价</div>
							...
							<div id="product_11345721" class="item item_selected ">
								<div class="item_form clearfix">
									...
									<div class="cell p-goods">
										<div class="p-img">
											<a href="javascript:;" target="_LBank">
												<img
					...
					<div class="cart-toolbar clearfix">
						<div class="total fr">
							...
							<p>
								<span id="totalRePrice">- ¥${buyerCart.free}</span>运费：
							</p>
						</div>
						<div class="amout fr">
